...
const Services = () => {
    return (
        <section className='services mb-24'>
            <h3 className='text-3xl py-1 text-center mb-5'>Services I Offer</h3>
            ...
            <div className="cards mt-20 md:flex gap-10">
                <div className="card shadow-lg p-10 rounded-xl flex flex-col items-center my-4 md:w-full">
                    <img src={Frontendimg} alt="Frontend" className='w-16 h-16' />
                    <h3 className='text-lg font-medium pt-8 pb-2'>Frontend</h3>
                    <p className='text-md leading-8 text-gray-500 text-center'>Lorem ipsum dolor sit amet.</p>
