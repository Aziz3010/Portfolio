...
const ProjectCard = ({ project }) => {
    ...
    return (
        <div className='project basis-1/3 flex-1 max-h-96'>
            <img src={productImage !== "" && productImage !== null ? `https://lowermost-heel.000webhostapp.com/uploads/${productImage}` : `https://lowermost-heel.000webhostapp.com/uploads/default.png`} alt={productName} className='object-cover' />
